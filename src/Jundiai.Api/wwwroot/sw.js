const CACHE='jundiai-healthos-poc-v15';
const ASSETS=['/','/index.html','/styles.css','/clinical.css','/auth-client.js','/app.js','/citizen.html','/operations.html','/esus.html','/acs.html','/manifest.webmanifest','/login.html','/poc.html','/poc.css','/poc.js','/evidence-pack.html','/evidence-pack.js','/dossier.html','/dossier.js','/contingency.html','/contingency.js','/caretrace.html','/caretrace.js','/registration.html','/registration.js','/workforce.html','/workforce.js','/referrals.html','/referrals.js','/clinical-ops.html','/clinical-ops.js','/agenda.html','/agenda.js','/telemedicine.html','/telemedicine-ui.js','/immunization-v2.html','/immunization-v2.js','/pharmacy-care.html','/pharmacy-care.js','/command-center.html','/command-center.js','/verification.html','/verification.js','/diagnostics.html','/diagnostics.js','/dental-v2.html','/dental-v2.js','/governance.html','/governance.js','/governance-persistence.js','/governance-privacy.js','/billing-v2.html','/billing-v2.js'];
