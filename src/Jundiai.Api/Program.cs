...
builder.Services.AddSingleton<ImmunizationAdvancedStore>();
builder.Services.AddSingleton<PharmacyCareStore>();
...
builder.Services.AddSingleton<ClinicalOrderStore>();
...
builder.Services.AddSingleton<PresentationContingencyStore>();
...
app.MapImmunizationAdvancedEndpoints();
app.MapPharmacyCareEndpoints();
